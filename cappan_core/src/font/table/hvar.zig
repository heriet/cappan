...
pub const HvarTable = struct {
    ...
    pub fn getAdvanceWidthDelta(self: HvarTable, glyph_id: u16, normalized_coords: []const f32) !i32 {
        ...
        if (self.advance_width_mapping_offset != 0) {
            const mapping = try self.readDeltaSetIndexMap(self.advance_width_mapping_offset);
    ...
    pub fn getLsbDelta(self: HvarTable, glyph_id: u16, normalized_coords: []const f32) !i32 {
        ...
        const mapping = try self.readDeltaSetIndexMap(self.lsb_mapping_offset);
    ...
    fn readDeltaSetIndexMap(self: HvarTable, map_offset: u32) !DeltaSetIndexMap {
    ...
    fn readMapEntry(self: HvarTable, mapping: DeltaSetIndexMap, index: u16) !MapEntry {
    ...
    fn getItemDelta(self: HvarTable, outer_index: u16, inner_index: u16, normalized_coords: []const f32) !i32 {
