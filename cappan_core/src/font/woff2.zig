...
const known_tags = [63][4]u8{
    ...
    "EBDT".*, "EBLC".*, "gasp".*, "hdmx".*, "kern".*, "LTSH".*, "PCLT".*,
    "VDMX".*, "vhea".*, "vmtx".*, "BASE".*, "GDEF".*, "GPOS".*, "GSUB".*,
    "EBSC".*, "JSTF".*, "MATH".*, "CBDT".*, "CBLC".*, "COLR".*, "CPAL".*,
    "SVG ".*, "sbix".*, "acnt".*, "avar".*, "bdat".*, "bloc".*, "bsln".*,
    "cvar".*, "fdsc".*, "feat".*, "fmtx".*, "fvar".*, "gvar".*, "hsty".*,
    "just".*, "lcar".*, "mort".*, "morx".*, "opbd".*, "prop".*, "trak".*,
